...
function onStepHit()
    if curStep == 610 or curStep == 724 or curStep == 841 or curStep == 888 or curStep == 1042 or curStep == 1221 or curStep == 1256 or curStep == 1369 or curStep == 1456 or curStep == 1544 or curStep == 1682 or curStep == 1794 or curStep == 2101 or curStep == 2146 or curStep == 2247 or curStep == 2298 or curStep == 2246 or curStep == 2496 or curStep == 2583 or curStep == 2597 then
        agressiveTails = true
